...
def task1(b, br, r, bl):
    ...
    print("Ймовірність, що навмання взята коробка виявиться червоною =", round((P(r, sum)), 2))
    print("Ймовірність, що навмання взята коробка виявиться синьою =", round((P(bl, sum)), 2))
    print("Ймовірність, що навмання взята коробка виявиться червоного або синього кольору =", (P(bl, sum) + P(r, sum)))
#     -----------------------------------------------------------------------------------------------------------------------
def P(b, sum):
    return (b / sum)
def A(n, m):
...
print("\nІПЗ-24 Обруснік Тетяна Віталіївна  ")
print("---------------------------------------------------------------------------------------------")
task1(40, 26, 22, 12)
print("---------------------------------------------------------------------------------------------")
task2(10,2,2)
